...
- [x] **REC-04**: System combines content-based and collaborative signals using hybrid weighted scoring
...
- [x] **UI-05**: User can provide like/dislike feedback on recommended movies
